<template>
  <div class="w-full h-full flex flex-col overflow-y-auto">
    <div class="flex-shrink-0 h-20 flex justify-between items-center lg:px-20">
      ...
      <p class="flex flex-col items-center">
        ...
        <span class="text-xs">Auto-syncs every 5 minutes.</span>
      </p>
      <div class="flex items-center space-x-4">
        <router-link to="/scholars" :class="``">Scholars</router-link>
<!--        <a href="#">Logout</a>-->
      </div>
    </div>
